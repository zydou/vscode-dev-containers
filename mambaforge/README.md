...
- Add [ipdb](https://github.com/gotcha/ipdb) package to the base environment.
...
| _Published image_                 | zydou/mambaforge:latest                                                                                         |
...
- `zydou/mambaforge` (or `zydou/mambaforge:latest`)

You can decide how often you want updates by referencing a [semantic version](https://semver.org/) of each image. For example:

- `zydou/mambaforge:4`
- `zydou/mambaforge:4.12`
- `zydou/mambaforge:4.12.0`
- `zydou/mambaforge:4.12.0-0`
  See [here for a complete list of available tags](https://hub.docker.com/r/zydou/mambaforge/tags).
